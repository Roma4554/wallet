...
class Wallet:
    ...
    Методы:
    add(self, record: Record) -> None - метод для добавления записи в .json, с учетом изменения баланса
    ...
    def add(self,
            record: Record) -> None:
        """Метод для добавления записи в .json, с учетом изменения баланса"""
